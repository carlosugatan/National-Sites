...
def process(response):
    ...
    # print(national_sites.description)
    return site_lst
...
def get_nearby_places(national_site):
    example_site = google_coordinates(national_site)
    example_site2 = google_nearby_places(google_coordinates.location)
    return []
